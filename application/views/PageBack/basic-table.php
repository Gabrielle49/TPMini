            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <?php echo form_open('home/listeObject')?>
                        <button type="submit" class="btn btn-danger pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light" name="Categorie">Categorie</button>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /row -->
